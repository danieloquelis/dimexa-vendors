class Strings {
  ...
  static const socketDefaultError = "Parece que tienes problemas de internet. Es necesario tener una conexión estable si es la primera vez que inicias el sistema, porfavor intenta otra vez.";
  static const timeoutDefaultError = "El tiempo de respuesta ha excedido los límites, es necesario tener una conexión estable si es la primera vez que inicias el sistema.";
